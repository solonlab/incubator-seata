...
public class RegistryMetadataPropertiesTest {
    ...
    @Test
    public void testRegistryMetadataProperties() {
        RegistryMetadataProperties properties = new RegistryMetadataProperties();

        properties.setExternal("http://localhost:8080");
        Assertions.assertEquals("http://localhost:8080", properties.getExternal());
    }
}
